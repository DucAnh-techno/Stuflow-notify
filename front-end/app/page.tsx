      ...
      <div className="relactive content-center">
        <div className="absolute">
          <div className="flex-col w-screen justify-center">
            <h1 className={`${pacifico.className} w-full text-center text-5xl mt-20 mb-10`}>Stuflow</h1>
            <div className="flex justify-center w-full">
              <div className="w-10/12 border rounded p-5">
                <div className={`${museoModerno.className} text-justify space-y-2`}>
                  <h2 className="text-red-500 pb-5 font-bold text-2xl text-center">Thân tình</h2>
                  ...
                  <div className="pl-5">
                    <ul className="list-disc">
                      <li>Khi cậu đăng nhập thành công tớ có thể biết được thông tin về tài khoản sinh viên của cậu &#40;tất cả luôn á&#41;.</li>
                    ...
                    <p><br></br>Đồng ý thì bấm nè → <button type="button" onClick={handleRouter} className="px-1 rounded hover:bg-gray-400 font-bold bg-gray-300 active:opacity-75 active:bg-gray-400">Login</button></p>
                  </div>
                </div>
              </div>
            </div>
